...
constexpr std::array<const char*, 256> get_legacy_draw_map()
{
	std::array<const char*, 256> legacy_draw_map;

	legacy_draw_map.fill("\0\0");
	...
	legacy_draw_map[(unsigned char)'\177'] = "71937 97 31";

	/// -- 7 bit ASCII boundary -- ///

	legacy_draw_map[(unsigned char)'\200'] = "1761575651";
	legacy_draw_map[(unsigned char)'\201'] = "47964~";
	legacy_draw_map[(unsigned char)'\202'] = "17 93";
