...
#include <string>
#include <vector>
#include "../SAFC_InnerModules/core_support.h"
...
{////per file settings
	...
	std::uint32_t bool_settings = default_processing_flags;
	...
	file_settings(const std::wstring& filename, std::uint32_t initial_flags = default_processing_flags);
