...
static double iif(double q, double a, double b) { return ((q > 0.) ? a : b); }

static double infinity() { return INFINITY; }
static double __notinf(double a) { return (double)(!isinf(a)); }
...
static const te_variable functions[] = {
    ...
    {"infinity", 
        infinity,     TE_FUNCTION0 | TE_FLAG_PURE, 0},
    {"isfinite", 
        __notinf,     TE_FUNCTION1 | TE_FLAG_PURE, 0},
    /*custom*/
